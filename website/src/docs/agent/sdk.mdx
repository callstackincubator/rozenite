...
Some official plugins publish ready-made typed tool descriptors under `./sdk`. Use those when you want the plugin package to provide the tool name, argument type, and result type for you.
