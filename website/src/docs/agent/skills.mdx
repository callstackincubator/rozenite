...
The skill complements Rozenite, it does not replace it. Your app still needs Rozenite installed and configured because the agent ultimately talks to the running app through `npx rozenite agent ...` commands.
