...
Rozenite for Agents requires a project with Rozenite already installed and configured. The agent skill teaches your coding agent how to use that setup effectively.
