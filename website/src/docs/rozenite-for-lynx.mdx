...
Rozenite for Lynx is experimental. It has been verified against LynxExplorer on the iOS Simulator and the Android emulator, not across the full range of LynxSDK versions and platforms, and the API may change in future releases.
:::
