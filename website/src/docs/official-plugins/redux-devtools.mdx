...
When running under Hermes, some could potentially hit an undefined `asyncIterator` and not see the log `connected to remotedev-server`, and not see the physical device in the inspector's selector.
Try the workaround of this [issue](https://github.com/reduxjs/redux-devtools/issues/1382#issuecomment-2093584916).
