...
<PackageManagerTabs command="npm install --save-dev @rozenite/expo-atlas-plugin" />

<PackageManagerTabs command="npm install --save-dev @rozenite/tanstack-query-plugin" />

<PackageManagerTabs command="npm install --save-dev @rozenite/network-activity-plugin" />
