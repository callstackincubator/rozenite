...
[React Query External Sync](https://github.com/LovesWorking/react-query-external-sync)
by Austin Johnson was crucial in making TanStack Query work in Rozenite. The internals
of this project served as a barebone foundation for Rozenite's equivalent implementation,
showing us how to effectively sync React Query state across different environments.
