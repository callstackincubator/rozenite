 ...
 */
export const ScreenshotSlot = ({ shows, ratio = 'wide', className }: ScreenshotSlotProps) => (
  <figure className={[styles.slot, RATIO_CLASS[ratio], className].filter(Boolean).join(' ')}>
