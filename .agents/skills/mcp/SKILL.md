...
4. Execute domain commands using the exact shape `rozenite mcp <domain> <action> ... --session <id> --json`.
...
- Valid: `rozenite mcp session create --json`
- Valid: `rozenite mcp <domain> list-tools --session <id> --json`
- Valid: `rozenite mcp <domain> get-tool-schema --tool <name> --session <id> --json`
- Valid: `rozenite mcp <domain> call-tool --tool <name> --args '<json>' --session <id> --json`
