...
import { useRozenitePluginMCPTool, type MCPTool } from '@rozenite/mcp-bridge';
...
type UseReactNavigationMCPToolsConfig<
...
const getRootStateTool: MCPTool = {
  name: 'get-root-state',
...
const getFocusedRouteTool: MCPTool = {
...
const dispatchActionTool: MCPTool = {
...
export const useReactNavigationMCPTools = <
  TNavigationContainerRef extends NavigationContainerRef<any> = NavigationContainerRef<any>
>({
  ref,
  getCurrentState,
  ...
  goBack,
  dispatchAction,
}: UseReactNavigationMCPToolsConfig<TNavigationContainerRef>) => {
  ...
  useRozenitePluginMCPTool<ListActionsInput>({
    pluginId,
  ...
  useRozenitePluginMCPTool<ResetRootInput>({
    pluginId,
    tool: resetRootTool,
    handler: ({ state }) => {
  ...
  useRozenitePluginMCPTool<OpenLinkInput>({
    pluginId,
    tool: openLinkTool,
    handler: async ({ href }) => {
  ...
  useRozenitePluginMCPTool<NavigateInput>({
    pluginId,
    tool: navigateTool,
  ...
  useRozenitePluginMCPTool<GoBackInput>({
    pluginId,
    tool: goBackTool,
    handler: ({ count = 1 }) => {
  ...
  useRozenitePluginMCPTool<DispatchActionInput>({
    pluginId,
