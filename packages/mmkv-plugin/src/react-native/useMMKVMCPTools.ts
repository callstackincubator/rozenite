...
const listStoragesTool: MCPTool = {
  name: 'list-storages',
...
export const useMMKVMCPTools = (views: MMKVView[]) => {
  ...
  useRozenitePluginMCPTool<ListEntriesInput>({
    pluginId: toolPrefix,
  ...
  useRozenitePluginMCPTool<KeyInput, { storageId: string; entry: MMKVEntry }>({
    pluginId: toolPrefix,
    tool: readEntryTool,
  ...
  useRozenitePluginMCPTool<SetInput>({
    pluginId: toolPrefix,
  ...
  useRozenitePluginMCPTool<KeyInput>({
    pluginId: toolPrefix,
