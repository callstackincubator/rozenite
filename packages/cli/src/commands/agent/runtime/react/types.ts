...
export interface ReactStartProfilingRequest {
...
export interface ReactStopProfilingRequest {
...
export interface ReactGetRenderDataRequest {
  rootId?: number;
  commitIndex?: number;
  limit?: number;
  cursor?: string;
  sort?: ReactRenderDataSort;
  slowRenderThresholdMs?: number;
}
